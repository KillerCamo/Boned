scoreboard players set PotionSlotSuccess BonerGame 0
$execute store success score PotionSlotSuccess BonerGame run data get storage camo:boned_data boned_effects[$(potion_slot)]
execute if score PotionSlotSuccess BonerGame matches 0 run return run say Potions Completed!
