...
execute unless items block ~ ~ ~ container.* bone[custom_data={Boned:1b}] if block ~ ~ ~ trapped_chest run return run execute as @s at @s run function camo:boned/check/double_trapped_chest
